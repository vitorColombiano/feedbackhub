...
<template>
  <main>
    ...
    <section class="m-10 p-5 border border-gray-300 rounded-lg text-center bg-white">
    ...
    <section class="m-10 grid grid-cols-2 gap-8">
      <div>
        ...
        <div v-for="feedbackItem in feedbackPositives" class="border border-green-600 p-4 rounded-2xl mt-6 w-full bg-white">
          <p class="font-mono text-sm">
            {{ feedbackItem.feedback }} / {{ feedbackItem.type }}
          </p>
        </div>
      </div>
      <div>
